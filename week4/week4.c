...
//delition at the beginning of list
...
//delition at the ending of list
void delete_at_end()
{
	cur =head;
	while(cur -> link != tail)
...
//delition at a position of list
void delete_at_pos()
{
	int pos,c=1;
...
//display of a sinlg linked list
void display()
{
	if(head==NULL)
